...
public class EditAudioStepActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stepTitleInput = findViewById(R.id.editText_audioStepTitle);
        stepImageView = findViewById(R.id.imageView_audioStepImage);
        audioSeekBar = findViewById(R.id.seekBar_audioStepRecording);
        ...
        if(!bundle.isEmpty() && bundle.containsKey(MainActivity.TASK_INTENT_EXTRA)){
            ...
            if(step.getAudioPath() != null){
                Uri uri = Uri.parse(step.getAudioPath());
                // TODO
            }
        }
    }
